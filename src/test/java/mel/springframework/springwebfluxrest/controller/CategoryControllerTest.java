...
public class CategoryControllerTest {
    ...
    public void testCreateCategory()
    {
        ...
        Mono<Category> catToSaveMono = Mono.just(Category.builder().description("This is a category").build());
    ...
    public void testUpdate()
    {
        ...
        Mono<Category> catToUpdateMono = Mono.just(Category.builder().description("This is a category").build());
